...
public:
	...
	afx_msg void OnProcessingCanny();
	afx_msg void OnProcessingDilation();
	afx_msg void OnProcessingErosion();
	afx_msg void OnProcessingConnectedcomponent();
	afx_msg void OnProcessingHough();
	afx_msg void OnAlgorithmDetect();
};
